...
.register-eyebrow { margin:0 0 7px; color:var(--accent); font-size:11px; font-weight:700; letter-spacing:.13em; text-transform:uppercase; }
...
.register-field label { color:var(--text); font-size:12px; font-weight:600; }
...
.social-divider { display:flex; align-items:center; gap:12px; margin:17px 0; color:var(--text-dim); font-size:11px; white-space:nowrap; }
...
.social-button { display:flex; align-items:center; justify-content:center; gap:9px; min-height:42px; padding:0 18px; border:1px solid var(--border-strong); border-radius:10px; background:var(--surface); color:var(--text); opacity:1; cursor:pointer; text-decoration:none; }
.social-button > svg { width:18px; height:18px; flex:none; }
.social-button span { font-size:12px; font-weight:600; }
.social-button:disabled { cursor:not-allowed; }
.social-button:not(:disabled):hover { border-color:#a99da9; background:#fff; box-shadow:0 3px 10px rgba(32,0,36,.08); text-decoration:none; }
.social-button:not(:disabled):focus-visible { outline:2px solid #a99da9; outline-offset:2px; text-decoration:none; }
.social-button--apple { border-color:#20231f; background:#20231f; color:#fff; }
.register-login { margin:19px 0 0; padding-top:17px; border-top:1px solid var(--border); color:var(--text-muted); font-size:12px; text-align:center; }
.register-link { color:var(--accent); font-weight:600; text-decoration:none; }
...
.register-header > p:last-child,.register-field label,.social-button span,.register-login,.register-link { font-size:14px; }
.social-divider { font-size:11px; }
@media(max-width:520px) { .register-header > p:last-child { font-size:14px; white-space:normal; } }
a.social-button,
a.social-button:link,
a.social-button:visited,
a.social-button:hover,
a.social-button:active { cursor:pointer; text-decoration:none !important; }
</style>
