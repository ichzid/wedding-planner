            ...
            <section v-else id="hasil-estimasi" class="result-section">
                <div class="container result-container">
                    ...
                    <div class="result-actions">
                        ...
                        <div class="save-area">
                            <Link :href="route('register')" class="primary-button result-save-button" @click="saveEstimateForOnboarding">Mulai Rencanakan Pernikahanmu <ArrowRight /></Link>
                            <Link :href="route('login')" class="result-login-link" @click="saveEstimateForOnboarding">Sudah punya akun? Masuk</Link>
                        </div>
                    </div>
...
.form-heading p,.form-progress>div:first-child,.concept-grid label,.compact-choices label,.field .field-help,.main-result-card>small,.gap-card>small,.breakdown-heading>div>span,.breakdown-copy span,.result-action-copy>span,.result-login-link{font-size:11px}.eyebrow,.trust-row,legend,.field>span,.input-wrap input,.input-wrap select,.primary-button,.secondary-button,.header-button,.footer-estimator,.footer-links a,.footer-links button{font-size:14px}.field .field-note,.result-intro>p,.main-result-card>p,.gap-card p,.breakdown-copy strong,.breakdown-item>b,.disclaimer p,.result-action-copy p{font-size:14px}.intro>p{font-size:18px}.form-heading h2{font-size:28px}.breakdown-heading h2,.gap-card h2{font-size:28px}
@media(max-width:700px){.intro>p{font-size:16px}.form-heading h2{font-size:28px}}

/* Sunset Marketplace — selaras dengan landing page */
.estimator-page{--aubergine:#240029;--fuchsia:#df37a7;--heather:#6d526d;--plum:#d4ccd4;--canvas:#fff;--warm:#fff1bd;min-height:100vh;background:#fff;color:var(--aubergine);font-family:'Inter',ui-sans-serif,system-ui,sans-serif}.container{width:min(1160px,calc(100% - 48px))}.estimator-hero{padding:164px 0 150px;background:linear-gradient(145deg,#ffbdd3,#fff1bd 48%,#ffcb0f)}.intro{max-width:1040px;margin:0 auto;text-align:center}.intro h1{max-width:1100px;margin:0 auto;color:var(--aubergine);font-family:'Bricolage Grotesque','Inter',ui-sans-serif,sans-serif;font-size:clamp(58px,6.8vw,86px);font-weight:800;line-height:1.04;letter-spacing:-.04em}.result-intro h1{color:var(--aubergine);font-family:'Bricolage Grotesque','Inter',ui-sans-serif,sans-serif;font-size:clamp(58px,6.8vw,86px);font-weight:800;line-height:1.04;letter-spacing:-.04em}.intro>p{max-width:900px;margin:32px auto 0;color:var(--heather);font-family:'Fraunces',Georgia,serif;font-size:clamp(20px,2.15vw,28px);font-weight:400;line-height:1.45;letter-spacing:-.02em}.decor-one{border:1px solid rgba(36,0,41,.14)}.decor-two{background:rgba(255,255,255,.18);border:0}.form-section{margin-top:-82px;padding-bottom:72px}.estimator-form{padding:40px;border:1px solid rgba(36,0,41,.14);border-radius:18px;background:#fff;box-shadow:0 20px 50px rgba(32,0,36,.12)}.form-heading{border-color:var(--plum)}.form-heading>span{border:0;border-radius:8px;background:#f7eff7;color:var(--fuchsia);font-family:'JetBrains Mono',monospace}.form-heading h2{color:var(--aubergine);font-family:'Bricolage Grotesque','Inter',sans-serif;font-size:30px;font-weight:800;letter-spacing:-.025em}.form-heading p,.form-progress>div:first-child{color:var(--heather)}.progress-track{height:6px;border:0;background:#eaddea}.progress-track span,.form-progress.complete .progress-track span{background:var(--fuchsia)}legend,.field>span{color:var(--aubergine);font-size:14px}legend b,.field b{color:var(--fuchsia)}.concept-grid label,.compact-choices label{min-height:48px;border:1px solid #767676;border-radius:6px;background:#fff;color:var(--aubergine);font-size:13px;box-shadow:none;transform:none}.concept-grid label:hover,.compact-choices label:hover{border-color:var(--heather);background:#fff;box-shadow:0 0 0 1px rgba(109,82,109,.12);transform:none}.concept-grid label.selected,.concept-grid label.selected:nth-child(n),.compact-choices label.selected,.compact-choices label.selected:nth-child(n){border-color:var(--fuchsia);background:#fff8fc;box-shadow:0 0 0 1px var(--fuchsia);color:var(--aubergine);transform:none}.concept-check,.compact-choices svg,.field>span svg{color:var(--fuchsia)}.input-wrap>svg:first-child{color:var(--heather)}.input-wrap input,.input-wrap select{height:52px;border:1px solid #767676;border-radius:3px;background:#fff;color:var(--aubergine);font-size:14px}.input-wrap input:hover,.input-wrap select:hover{border-color:var(--heather)}.input-wrap input:focus,.input-wrap select:focus{border-color:var(--fuchsia);box-shadow:0 0 0 2px rgba(223,55,167,.14)}.field.filled .input-wrap input,.field.filled .input-wrap select{border-color:var(--heather);background:#fff}.currency,.suffix,.field .field-note{color:var(--heather)}.submit-button{width:auto;min-width:280px;min-height:58px;margin:34px auto 0;padding:0 30px;border:0;border-radius:6px;background:var(--fuchsia);color:#fff;box-shadow:inset 0 0 0 1px rgba(255,255,255,.2),0 1px 2px rgba(0,0,0,.05);font-family:'Inter',ui-sans-serif,sans-serif;font-size:16px;font-weight:600}.primary-button.submit-button:not(.ready),.submit-button.ready,.primary-button.ready{background:var(--fuchsia);color:#fff;box-shadow:inset 0 0 0 1px rgba(255,255,255,.2),0 1px 2px rgba(0,0,0,.05);animation:none}.submit-button:hover:not(:disabled){background:#c92b96;box-shadow:inset 0 0 0 1px rgba(255,255,255,.2),0 4px 12px rgba(32,0,36,.16);transform:translateY(-2px)}.submit-button:disabled{background:var(--fuchsia);cursor:not-allowed;opacity:.48}.result-section{padding:144px 0 96px;background:linear-gradient(180deg,#fff1bd 0,#fff 360px)}.result-intro{max-width:960px;margin-bottom:48px}.result-intro h1 span{white-space:normal}.result-intro>p{max-width:850px;margin:22px auto 0;color:var(--heather);font-size:16px;line-height:1.65}.result-grid{gap:20px}.main-result-card,.gap-card,.breakdown-card{border:1px solid rgba(36,0,41,.14);border-radius:16px;box-shadow:0 10px 28px rgba(32,0,36,.08)}.main-result-card,.main-result-card:hover{padding:34px;border-color:rgba(223,55,167,.18);background:linear-gradient(145deg,#fff8fc 0%,#f7eff7 58%,#fff7d9 100%);color:var(--aubergine);box-shadow:0 10px 28px rgba(32,0,36,.08);transform:none}.main-result-card::after,.gap-card::after{display:none}.main-result-card>small,.gap-card>small{padding:0;border:0;background:transparent;box-shadow:none;font-family:'JetBrains Mono',monospace;font-size:11px}.main-result-card>small{color:var(--fuchsia)}.main-result-card>strong{margin:14px 0 9px;color:var(--aubergine);font-family:'Bricolage Grotesque','Inter',sans-serif;font-size:clamp(36px,4vw,50px)}.main-result-card>p{color:var(--heather);font-size:14px}.available-row{margin-top:28px;padding:16px 0 0;border:0;border-top:1px solid rgba(36,0,41,.14);background:transparent;font-size:14px}.available-row b{font-size:16px}.gap-card,.gap-card.enough,.gap-card.close,.gap-card:hover{padding:28px;background:#f7eff7;color:var(--aubergine);box-shadow:0 10px 28px rgba(32,0,36,.08);transform:none}.gap-card.gap{background:var(--warm)}.gap-card.enough{background:#e6f2e5}.gap-icon{width:44px;height:44px;border:0;border-radius:12px;background:#fff;color:var(--fuchsia);box-shadow:0 1px 3px rgba(32,0,36,.08)}.gap-card>small{color:var(--heather)}.gap-card h2{color:var(--aubergine);font-family:'Bricolage Grotesque','Inter',sans-serif;font-size:30px}.gap-card p{color:var(--heather);font-size:14px}.breakdown-card{margin-top:20px;padding:32px;background:#fff}.breakdown-heading{margin-bottom:24px;padding:0 0 22px;border-bottom:1px solid var(--plum)}.breakdown-heading>div>span{padding:0;border:0;background:transparent;color:var(--fuchsia);box-shadow:none;font-family:'JetBrains Mono',monospace}.breakdown-heading h2{color:var(--aubergine);font-family:'Bricolage Grotesque','Inter',sans-serif;font-size:32px}.breakdown-heading h2::after{display:none}.total-chip{border:1px solid var(--plum);border-radius:8px;background:#f7eff7;color:var(--aubergine)!important;box-shadow:none}.breakdown-list{gap:0 28px}.breakdown-item,.breakdown-item:nth-child(n){padding:16px 0;border:0;border-top:1px solid #eaddea;border-radius:0;background:#fff;box-shadow:none;transform:none}.breakdown-item:hover{background:#fff;box-shadow:none;transform:none}.breakdown-copy strong,.breakdown-item>b{color:var(--aubergine);font-size:13px}.breakdown-copy span{min-width:auto;height:auto;padding:0;border:0;background:transparent;color:var(--heather);font-size:12px}.bar{height:6px;border:0;background:#eaddea}.bar span,.breakdown-item:nth-child(n) .bar span{background:var(--fuchsia);box-shadow:none}.disclaimer{margin-top:20px;border:1px solid var(--plum);border-radius:12px;background:#fffaf0;box-shadow:none}.disclaimer svg{color:var(--fuchsia)}.disclaimer p{color:var(--heather);font-size:13px}.result-actions{margin-top:24px;padding:40px;border:0;border-radius:16px;background:var(--aubergine);color:#fff;box-shadow:0 14px 34px rgba(32,0,36,.16)}.result-actions::after{display:none}.result-action-copy>span{padding:0;border:0;background:transparent;color:var(--plum);box-shadow:none;font-family:'JetBrains Mono',monospace}.result-action-copy h2{color:#fff;font-family:'Bricolage Grotesque','Inter',sans-serif;font-size:clamp(28px,3vw,38px)}.result-action-copy p{color:var(--plum);font-size:14px}.save-area .result-save-button,.save-area .primary-button.result-save-button:not(.ready){border:0;border-radius:10px;background:var(--fuchsia);color:#fff;box-shadow:none}.save-area .result-save-button:hover{background:#c92b96;box-shadow:none;transform:translateY(-2px)}.result-login-link{color:var(--plum)}.secondary-button{min-height:48px;border:1px solid var(--plum);border-radius:10px;background:#fff;color:var(--aubergine)}.secondary-button:hover{border-color:var(--aubergine);background:#fff;transform:translateY(-2px)}
@media(max-width:700px){.container{width:min(100% - 28px,1160px)}.estimator-hero{padding:128px 0 112px}.intro h1,.result-intro h1{font-size:clamp(40px,12vw,52px)}.intro>p{font-size:17px}.form-section{margin-top:-58px;padding-bottom:52px}.estimator-form{padding:26px 20px}.form-heading h2{font-size:25px}.result-section{padding:112px 0 72px}.breakdown-card{padding:24px 20px}.result-actions{padding:30px 22px}.main-result-card>strong{font-size:34px}}
</style>
